//Персонаж Х должен съесть все точки, двигаясь по лабиринту.
//Движение осуществляется стрелками.
//При столкновении с призраками G персонаж теряет жизнь(всего их 3)
